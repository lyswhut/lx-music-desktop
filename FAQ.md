...
## 我的Deepin Linux安装后无法卸载

Deepin Linux无法在“启动器”应用列表中通过右键方式卸载，也无法在“应用商店”->“卸载应用”列表中找到“洛雪音乐助手”。<br>

你需要再次打开.deb安装包，此时Deepin安装器会提示您“已安装此软件”，点击下方的“卸载”按钮可以正常完成卸载。<br>

>如果您已经删除了所安装版本的.deb安装包，请重新下载对应版本和系统位数的.deb安装包

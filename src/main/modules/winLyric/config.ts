...
import { closeWindow, createWindow, getBounds, isExistWindow, alwaysOnTopTools, mouseCheckTools, setBounds, setIgnoreMouseEvents, setSkipTaskbar } from './main'
...
const updateMouseCheck = () => {
  if (isLock && isHoverHide && !isLinux) {

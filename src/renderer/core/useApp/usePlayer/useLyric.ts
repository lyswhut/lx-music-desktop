...
export default () => {
  ...
  watch(() => appSetting['player.isShowLyricPhonetic'], setLyric)
  watch(() => appSetting['player.isShowLyricRomaWordByWord'], setLyric)
  watch(() => appSetting['player.isSwapLyricMainAndRoma'], setLyric)

...
dd
  ...
  div
    base-btn.btn.gap-left(outline @click="handleImportPlayList") {{ $t('setting__backup_part_import_list') }}
    base-btn.btn.gap-left(outline @click="handleExportPlayList") {{ $t('setting__backup_part_export_list') }}
    base-btn.btn.gap-left(outline @click="handleImportSetting") {{ $t('setting__backup_part_import_setting') }}
    base-btn.btn.gap-left(outline @click="handleExportSetting") {{ $t('setting__backup_part_export_setting') }}
dd
  h3#backup_all {{ $t('setting__backup_all') }}
  div
    base-btn.btn.gap-left(outline @click="handleImportAllData") {{ $t('setting__backup_all_import') }}
    base-btn.btn.gap-left(outline @click="handleExportAllData") {{ $t('setting__backup_all_export') }}
dd
  h3#backup_other {{ $t('setting__backup_other') }}
  div
    base-btn.btn.gap-left(outline @click="handleExportPlayListToText") {{ $t('setting__backup_other_export_list_text') }}
    base-btn.btn.gap-left(outline @click="handleExportPlayListToCsv") {{ $t('setting__backup_other_export_list_csv') }}
</template>

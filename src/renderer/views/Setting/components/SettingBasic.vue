...
dd
  h3#basic_list_cover {{ $t('setting__basic_list_cover') }}
  div
    .gap-top
      base-checkbox(id="setting_list_show_cover" :model-value="appSetting['list.isShowCover']" :label="$t('setting__basic_list_show_cover')" @update:model-value="updateSetting({'list.isShowCover': $event})")
...
export default {
  ...
  setup() {
    ...
    const coverSizeList = computed(() => {
      return [
        { id: 32, label: t('setting__basic_list_cover_size_32px') },
        { id: 44, label: t('setting__basic_list_cover_size_44px') },
        { id: 56, label: t('setting__basic_list_cover_size_56px') },
        { id: 72, label: t('setting__basic_list_cover_size_72px') },
      ]
    })

...
dd(:aria-label="$t('setting__download_path_title')")
  ...
  div
    ...
    .p
      base-btn.btn(outline @click="handleChangeSavePath") {{ $t('setting__download_path_change_btn') }}
...
dd
  ...
  div
    p
      base-selection.gap-left(chrome="source" :class="$style.selectWidth" :model-value="appSetting['download.maxDownloadNum']" :list="maxNums" item-key="id" item-name="id" @change="handleUpdateMaxNum")

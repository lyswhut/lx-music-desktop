...
dd
  ...
  div
    ...
    .p
      base-btn.btn(outline :disabled="isDisabledResourceCacheClear" @click="clearResourceCache") {{ $t('setting__other_resource_cache_clear_btn') }}
...
dd
  ...
  div
    ...
    .p
      base-btn.btn(outline :disabled="isDisabledOtherSourceCacheClear" @click="handleClearOtherSourceCache") {{ $t('setting__other_other_source_clear_btn') }}
      base-btn.btn(outline :disabled="isDisabledMusicUrlCacheClear" @click="handleClearMusicUrlCache") {{ $t('setting__other_music_url_clear_btn') }}
      base-btn.btn(outline :disabled="isDisabledLyricRawCacheClear" @click="handleClearLyricRawCache") {{ $t('setting__other_lyric_raw_clear_btn') }}
...
dd
  ...
  div
    ...
    .p
      base-btn.btn(outline @click="isShowDislikeList = true") {{ $t('setting__other_dislike_list_show_btn') }}
...
dd
  ...
  div
    ...
    .p
      base-btn.btn(outline :disabled="isDisabledLyricEditedCacheClear" @click="handleClearLyricEditedCache") {{ $t('setting__other_lyric_edited_clear_btn') }}

dd
  h3#other_lyric_edited {{ $t('setting__other_listdata') }}
  div
    .p
      base-btn.btn(outline @click="handleClearListData") {{ $t('setting__other_listdata_clear_btn') }}
